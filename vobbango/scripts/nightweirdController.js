...
var xOrigin = (caller.body.x + caller.body.width / 2) - state.player.x;
var yOrigin = (caller.y) - state.player.y;
...
{
  shooting.next(yield);
  if ((caller.body.x + caller.body.width / 2) - state.player.x < xOrigin) caller.body.velocity.x = caller.properties.moveSpeed;
  if ((caller.body.x + caller.body.width / 2) - state.player.x > xOrigin) caller.body.velocity.x = -1 * caller.properties.moveSpeed;
  if ((caller.y) - state.player.y < yOrigin) caller.body.velocity.y = caller.properties.moveSpeed;
  if ((caller.y) - state.player.y > yOrigin) caller.body.velocity.y = -1 * caller.properties.moveSpeed;
}
